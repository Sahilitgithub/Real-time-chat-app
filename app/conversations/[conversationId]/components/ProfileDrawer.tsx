...
const ProfileDrawer: React.FC<ProfileDrawerProps> = ({
  ...
  const [confirmOpen, setConfirmOpen] = useState<boolean>(false); // ✅ start closed
  ...
  return (
    <>
      ...
      {/* Profile Drawer */}
      <Transition as={Fragment} show={onOpen}>
                      ...
                      <div className="px-4 sm:px-6">
                        <div className="flex items-start justify-end">
                          <button
                            type="button"
                            onClick={onClose}
                            className="rounded-md bg-white text-gray-600 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2"
                          >
